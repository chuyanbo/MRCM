...
para_save_u3=path_SRT+"/LLSRT/para/UNet/UNetpp/q_Unet_GPU.pth"
para_load_u3=path_SRT+"/LLSRT/para/UNet/UNetpp/q_Unet_GPU.pth" #now 6 attention
...
python -m torch.distributed.launch --nproc_per_node=6 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=22222 /mnt/LLSRT/Tooth_queue_train2.py
"""
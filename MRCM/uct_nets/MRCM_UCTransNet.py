...
class DownBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, nb_Conv, activation='ReLU'):
        ...
        self.nConvs55 = _make_nConv(in_channels, out_channels, nb_Conv, activation,k_size=3)
        self.nConvs55_1 = _make_nConv(in_channels, out_channels, nb_Conv-1, activation,k_size=3)
        self.nConvs55_2 = _make_nConv(in_channels, out_channels, nb_Conv-2, activation,k_size=3)
        
        self.conv_out =  _make_nConv(out_channels*2, out_channels, 1, activation,k_size=1)
    ...
    def forward(self, x):
        ...
        return self.conv_out(torch.cat([conv33,conv55],dim=1))

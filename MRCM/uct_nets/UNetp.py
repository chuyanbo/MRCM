...
class UNetp(nn.Module):
    def __init__(self, n_channels=1, n_classes=1):
        ...
        self.up4 = UpBlock2(in_channels*16, in_channels*8, nb_Conv=2)
        self.up3 = UpBlock2(in_channels*8, in_channels*4, nb_Conv=2)
        self.up2 = UpBlock2(in_channels*4, in_channels*2, nb_Conv=2)
        self.up1 = UpBlock2(in_channels*2, in_channels, nb_Conv=2)
    ...
    def forward(self, x):
        ...
        # print(x31.shape)
        x21 = self.up3(x30, x20) #x30和x20维度不一样？
        x22 = self.up3(x31, x21) # 问题，x21维度和x20并不一样

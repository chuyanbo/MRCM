...
from uct_nets.ResUCTransNet import ResUCTransNet
from uct_nets.MRCM_UCTransNet import MUCTransNet
...
para_save_u3=path_SRT+"/LLSRT/para/ResUCTransNet/DCconv335577_conv_123_6attention_1.5ratio/MRCM_UCTransNet.pth"
para_load_u3=path_SRT+"/LLSRT/para/ResUCTransNet/DCconv335577_conv_123_6attention_1.5ratio/MRCM_UCTransNet.pth" #now 6 attention
...
model4 = MUCTransNet(config3,n_channels=1,n_classes=classes,img_size=320)
model4.to(device)
if multiGPU :
...
optimizer4 = optim.Adam(model4.parameters(),lr=lr,weight_decay=1e-8)
...
python -m torch.distributed.launch --nproc_per_node=2 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=22222 /mnt/LLSRT/Tooth_queue_train.py
"""